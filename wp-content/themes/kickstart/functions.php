...
function kickstart_scripts_init() {
	...
	wp_enqueue_script( 'action', get_template_directory_uri() . '/js/action.js', array( 'jquery' ) );
}
...
function kickstart_styles_init() {
	...
	wp_enqueue_style( 'owl-carousel', get_template_directory_uri() . '/owl-carousel/owl.carousel.min.css' );
